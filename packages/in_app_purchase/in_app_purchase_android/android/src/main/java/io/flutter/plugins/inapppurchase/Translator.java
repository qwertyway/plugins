...
/*package*/ class Translator {
  ...
  static HashMap<String, Object> fromPurchase(Purchase purchase) {
    ...
    info.put("sku", purchase.getSkus().isEmpty() ? null : purchase.getSkus().get(0));
  ...
  static HashMap<String, Object> fromPurchaseHistoryRecord(
    ...
    info.put("sku", purchaseHistoryRecord.getSkus().isEmpty() ? null : purchaseHistoryRecord.getSkus().get(0));
